<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Private.Master"
    AutoEventWireup="true" CodeBehind="CreateRunawayRequest.aspx.cs"
    ValidateRequest="false"
    Inherits="RAMS.WebApp.Services.RAMS.MyClients.CreateRunawayRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col s12 m12 l12">
            <uc1:ValidateRequesterEstablishmentUsers
                runat="server"
                ID="ucValidateBusinessUser"
    ...
    <div class="card" id="mainCardDiv" runat="server" visible="true">
        <div class="title">
            ...
            <div id="containerDiv" runat="server">
                ...
                <div id="requestInfoDiv" runat="server" visible="False">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m2 l2">
                                <asp:RequiredFieldValidator runat="server" ID="laborerStartWorkDateRequiredFieldValidator"
                                    ForeColor="Red" ValidationGroup="save" ErrorMessage="*" ControlToValidate="LaborerStartWorkDateCalendar">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m2 l2">
                                <asp:RequiredFieldValidator runat="server" ID="laborerEndWorkDateRequiredFieldValidator"
                                    ForeColor="Red" ValidationGroup="save" ErrorMessage="*" ControlToValidate="LaborerEndWorkDateDualSmartCalendar">
                                </asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col s12 m2 l2">
                                <asp:RequiredFieldValidator runat="server" ID="lastLaborerSalaryRequiredFieldValidator"
                                    ForeColor="Red" ValidationGroup="save" ErrorMessage="*" ControlToValidate="LastLaborerSalaryDualSmartCalendar">
                                </asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col s12 m5 l5">
                                <asp:TextBox ID="reasonEndLaborerRelationShipTextBox" runat="server"
                                    ValidationGroup="save" MaxLength="500" Height="130"
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m3 l3">
                            <asp:Button runat="server" ValidationGroup="save" ID="createRunwayRequestButton" Text="تقديم الطلب"
