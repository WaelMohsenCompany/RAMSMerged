<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Private.Master"
    ...
    Inherits="RAMS.WebApp.Services.RAMS.Establishment.RunawayRequestsManagement" %>

<%@ Register Src="~/Services/RAMS/UserControls/UcSearchingByIqamaOrBorderNumber.ascx"
    TagPrefix="uc2" TagName="LaborerUserControl" %>
<%@ Register Assembly="Mol.Web.Common.WebControls" Namespace="Mol.Web.Common.WebControls"
    TagPrefix="DateControl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="RunwayRequestCardDiv" class="card" runat="server" visible="True">
        <div class="title">
        ...
        <div class="content">
            ...
            <div id="runawayDetailsDiv" runat="server">
                ...
                <div id="Contentdiv" runat="server">
                    <%--رقم البلاغ المرجعي & اسم المنشـأة--%>
                    <div class="row">
                        <%--رقم البلاغ المرجعي--%>
            ...
            <br />
            <div id='uploadFileBookmarkDiv' class="row"></div>
            <%--الغاء بلاغ هروب --%>
            <div runat="server" id="deleteRunAwayDiv" visible="False">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m2 l2" id="uploadDiv">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkDelete" Text="حذف" CommandArgument='<%# Eval("Name") %>'
                                                runat="server" OnClick="DeleteFile" CommandName="DeleteFile" CausesValidation="False" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                ...
                <div id="questionsDiv">
                    ...
                    <div class="row">
                        <div class="col s12 m2 l2">
                            <span><b>ماهي أسباب إلغاء بلاغ التغيب ؟  <b style="color: red">*</b></b></span>
                        </div>
                        <div class="col s12 m6 l6">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m1 l1">
                        <div class="label-new">
                            <asp:Button runat="server" ID="deleteRunAwayRequestButton"
