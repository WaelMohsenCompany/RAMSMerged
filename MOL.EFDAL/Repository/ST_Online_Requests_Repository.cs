...
{
    public partial class ST_Online_Requests_Repository : EFRepository<ST_Online_Requests>
    {
        public ST_Online_Requests_Repository()
        {
            Context = new MOLEFEntities();
        }

        public ST_Online_Requests_Repository(MOLEFEntities context) : base(context)
        {
