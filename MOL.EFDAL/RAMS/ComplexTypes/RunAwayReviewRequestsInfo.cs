...
// ***********************************************************************
// <copyright file="RunAwayReviewRequestsInfo.cs" company="MOL">
//     Copyright © MOL 2014
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MOL.EFDAL.ComplexTypes
{
    ...
    public class RunAwayReviewRequestsInfo
    {
        ...
        [DataMember]
        public List<string> RunAwayFilesPaths { get; set; }
        ...
        [DataMember]
        public List<string> ComplaintFilesPaths { get; set; }
        ...
        /// <summary>Gets or sets the identifier of the establishment.</summary>
        /// <value>The identifier of the establishment.</value>
        [DataMember]
