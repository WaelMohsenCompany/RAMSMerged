...
// ***********************************************************************
// <copyright file="RunAwayApprovalRequestsInfo.cs" company="Tasleem IT for MLSD">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Class RunAwayApprovalRequestsInfo.
    /// </summary>
    [DataContract]
    [Serializable]
    public class RunAwayApprovalRequestInfo
    {
        //==========================================================
        //RunAway Data
        /// <summary>
        ...
        //==========================================================
        /// <summary>
        /// Gets or sets a value indicating whether this request instance is beyond initial action period.
        /// </summary>
        /// <value><c>true</c> if this request instance is beyond initial action period; otherwise, <c>false</c>.</value>
        [DataMember]
        public bool IsBeyondInitialActionPeriod { get; set; }
        //==========================================================
        //Rows Count
        /// <summary>
